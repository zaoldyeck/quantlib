...
- Baseline run → `src/quantlib/strat_lab/v4.py` (5.6s)
...
- New strategy variant → fork `src/quantlib/strat_lab/v4.py` with one-liner change, re-run
