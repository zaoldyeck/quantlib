...
影響:src/quantlib/prices.py 的還原價與 total_return_series(0050 基準)會少算這些配息。

Run: uv run --project . python docs/data_audit/scripts/C-ex_right_dividend/12_etf_gap.py
"""
