...
Run: uv run --project research python docs/data_audit/scripts/C-ex_right_dividend/08_coverage_and_anomaly.py
"""
...
def main() -> None:
    ...
    """).df()
    print(df.to_string())
    print("\n  → 用 research/data_calendar.is_trading_day 複核(0-byte sentinel 休市日曆):")
