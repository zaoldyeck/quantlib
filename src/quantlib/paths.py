...
CACHE_DIR = VAR / "cache"
#: 全表 DuckDB 快照(唯一結構化真源;由 src/quantlib/crawl/rebuild.py 從 raw 封存重建、
#: quantlib.crawl.update 每日增量更新。PostgreSQL 已退役 2026-07-23)
...
RECORDS = REPO / "src" / "quantlib" / "records"
