...
Run: uv run --project . python -m quantlib.crawl.slim_cache [--since 2023-01-01] [--verify]
依賴:cache.duckdb 為最新。
"""
...
#: S 決策 + 爬蟲會讀寫的表(唯一依賴集;見 src/quantlib/apex/data.py 溯源)
