...
Run:
    uv run --project . python -m quantlib.crawl.tests.test_cash_flows_parity
    uv run --project . python -m quantlib.crawl.tests.test_cash_flows_parity --all
    uv run --project . python -m quantlib.crawl.tests.test_cash_flows_parity --fetch-check 2026 1
    uv run --project . python -m quantlib.crawl.tests.test_cash_flows_parity --coverage-evidence
"""
...
from quantlib.crawl.sink import CACHE_DB
