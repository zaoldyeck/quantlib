...
Run(單季解析已封存 raw):
    uv run --project . python -m quantlib.crawl.sources.cash_flows 2020 2
"""
...
from quantlib.crawl import http, parse
...
#       docs/data_audit 對照腳本 / src/quantlib/crawl/tests(cache 內 daily_quote × cf 覆蓋率)。
#
