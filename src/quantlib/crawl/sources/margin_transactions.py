...
Run(parity):uv run --project . python -m quantlib.crawl.tests.test_margin_transactions_parity
"""
...
from quantlib.crawl.parse import SchemaDrift, minguo_slash, twse_date
