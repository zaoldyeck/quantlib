...
Run:
  uv run --project . python -m quantlib.evergreen.label_monthly prompt 2026-07
  uv run --project . python -m quantlib.evergreen.label_monthly validate --input out.json
  uv run --project . python -m quantlib.evergreen.label_monthly merge --input out.json
...
EG = Path("src/quantlib/evergreen")
