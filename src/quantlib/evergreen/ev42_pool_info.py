...
Run: uv run --project . python -m quantlib.evergreen.ev42_pool_info
...
from quantlib.evergreen.ev36_walkforward import C, Lab, seg_kpi
from quantlib.evergreen.ev38_exhaust import FOLDS, bench

OUT = "src/quantlib/evergreen/data/ev42_results.parquet"
