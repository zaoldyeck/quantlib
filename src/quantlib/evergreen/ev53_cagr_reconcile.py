...
Run: uv run --project . python -m quantlib.evergreen.ev53_cagr_reconcile
依賴 cache: 是
"""
...
from quantlib.evergreen.ev53_mdd_cap import LIVE, build_sc, nav_of
...
def main() -> None:
    ...
    try:
        from quantlib.tri.pnl_dashboard import evergreen_nav
