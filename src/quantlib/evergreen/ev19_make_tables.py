...
需要 cache 最新。Run:
  uv run --project . python -m quantlib.evergreen.ev19_make_tables 2023-02-01 ...
"""
...
from quantlib.evergreen.ev18_make_packs import fin_asof
from quantlib import paths

SRC = "src/quantlib/evergreen/data/ev17_tables"
OUT = "src/quantlib/evergreen/data/ev19_tables"
