...
需要 cache 最新。Run: uv run --project . python -m quantlib.evergreen.ev16_discipline_check
"""
...
def main() -> None:
    b13 = (pl.read_parquet("src/quantlib/evergreen/data/ev13_duel_labels.parquet")
           .filter(pl.col("arm") == "B")
