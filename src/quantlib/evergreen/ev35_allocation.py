...
Run: uv run --project . python -m quantlib.evergreen.ev35_allocation
"""
...
def load_navs() -> pl.DataFrame:
    ...
    # v3.3 NAV:重跑一次落檔(決定性)
    import os
    v3p = "src/quantlib/evergreen/data/v33_nav.parquet"
    if not os.path.exists(v3p):
        ...
        from quantlib.evergreen.ev30_campaign import Lab3
