...
Run: uv run --project . python -m quantlib.evergreen.ev14_duel
"""
...
from quantlib.evergreen.harvest import (C, build_feats, daily_membership,
...
def main() -> None:
    duel = pl.read_parquet("src/quantlib/evergreen/data/ev14_duel_labels.parquet")
    a13 = (pl.read_parquet("src/quantlib/evergreen/data/ev13_duel_labels.parquet")
