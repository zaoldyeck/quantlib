...
Run: uv run --project . python -m quantlib.evergreen.ev30_campaign
"""
...
from quantlib.evergreen.harvest import C, build_feats
...
class Lab3:
    def __init__(self) -> None:
        self.reg = pl.read_parquet("src/quantlib/evergreen/data/registry_v3.parquet")
        con = data.connect()
