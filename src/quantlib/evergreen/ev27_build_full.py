...
Run: uv run --project . python -m quantlib.evergreen.ev27_build_full
"""
...
DATA = "src/quantlib/evergreen/data"
...
def main() -> None:
    ...
    md = open("src/quantlib/evergreen/PROMPT_ev27_attribution.md").read()
    ...
    open("src/quantlib/evergreen/workflows/ev27_full.js", "w").write(script)
