...
Run: uv run --project . python -m quantlib.evergreen.ev28_validate <task_output_file>
"""
...
OUT = "src/quantlib/evergreen/data/ev28_pilot_labels.parquet"
...
def main() -> None:
    ...
    import os
    for m in STANCE:
        p = f"src/quantlib/evergreen/data/ev28_news/{m}/materials.json"
