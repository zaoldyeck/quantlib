...
Run: uv run --project . python -m quantlib.evergreen.ev24_baseline
"""
...
def main() -> None:
    ...
    for name, path in [("v1", "src/quantlib/evergreen/data/registry_v1.parquet"),
                       ("v2", "src/quantlib/evergreen/data/registry_v2.parquet")]:
