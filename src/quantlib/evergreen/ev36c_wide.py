...
Run: uv run --project . python -m quantlib.evergreen.ev36c_wide
依賴 cache: 是
"""
...
from quantlib.evergreen.ev36_walkforward import Lab, run_cfg, seg_kpi, TRAIN0, TRAIN1
...
def main() -> None:
    ...
    df.write_parquet("src/quantlib/evergreen/data/ev36c_wide.parquet")
    print(df.head(8))
