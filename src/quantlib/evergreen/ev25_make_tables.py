...
需要 cache 最新。Run:
  uv run --project . python -m quantlib.evergreen.ev25_make_tables 2023-02 2023-08 2024-03 2025-04
"""
...
from quantlib.evergreen.make_tables import C, build_feats, load_rev
from quantlib.evergreen.make_tables_chips import chips_asof
from quantlib import paths

OUT = "src/quantlib/evergreen/data/ev25_tables"
