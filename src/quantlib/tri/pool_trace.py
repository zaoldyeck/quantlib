...
Run:
  uv run --project . python -m quantlib.tri.pool_trace 2059 6446
  uv run --project . python -m quantlib.tri.pool_trace 2059 --since 2025-01-01
"""
...
from quantlib.tri.advisors import C, S_WTS
