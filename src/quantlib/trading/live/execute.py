...
用法:
  ...
  # 測試(不查取消、強制 dry):
  uv run --project . python -m quantlib.trading.live.execute --no-cancel-check --dry
"""
...
def main() -> None:
    ...
    from quantlib.brokers.fubon import load_env_file
    from quantlib.trading.live import notify
    from quantlib.trading.live.premarket import plan_path
