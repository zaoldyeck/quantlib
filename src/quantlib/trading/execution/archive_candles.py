...
用法:
  ...
  # 追加候選池代碼
  uv run --project . python -m quantlib.trading.execution.archive_candles --codes 6488,3026,8261
"""
...
from quantlib.brokers.fubon import FubonBroker, load_env_file
...
def main() -> None:
    ...
    if not args.no_inventory:
        from quantlib.trading.portfolio import positions_from_fubon_inventories
