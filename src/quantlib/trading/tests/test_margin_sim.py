...
Run: uv run --project . python -m quantlib.trading.tests.test_margin_sim
     或 uv run --project . pytest src/quantlib/trading/tests/test_margin_sim.py
"""
...
from quantlib.trading.margin_sim import (BUY_COST, FIN_RATE, FORCED_COST,
