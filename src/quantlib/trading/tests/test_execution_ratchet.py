...
跑:
    ...
    uv run --project . python -m pytest src/quantlib/tests/test_execution_ratchet.py -v
"""
...
from quantlib.trading.execution.engine import ExecutionEngine, Quote
from quantlib.trading.execution.microstructure import MicrostructureDetector
from quantlib.trading.execution.policy import (BUY_NORMAL, BUY_PATIENT,
...
def test_capture_bps_scorecard():
    from quantlib.trading.execution.engine import LegResult
