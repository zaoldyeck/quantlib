...
run: uv run --project . python -m pytest src/quantlib/tests/test_exit_replay.py -q
"""
...
from quantlib.trading.exit_replay import (evergreen_rule, replay,  # noqa: E402
...
def test_action_block_surfaces_overdue():
    ...
    from quantlib.tri.report import action_block
