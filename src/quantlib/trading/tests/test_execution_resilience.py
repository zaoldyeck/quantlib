...
run:  uv run --project . python -m pytest src/quantlib/tests/test_execution_resilience.py -q
"""
...
from quantlib.brokers.fubon import (  # noqa: E402
    is_transient_network_error, net_retry,
)
from quantlib.trading.execution.engine import ExecutionEngine, Quote  # noqa: E402
from quantlib.trading.execution.policy import PROFILES  # noqa: E402
...
def test_startup_outage_waits_then_completes(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("quantlib.brokers.fubon.time.sleep", lambda s: None)
    b = FakeBroker()
