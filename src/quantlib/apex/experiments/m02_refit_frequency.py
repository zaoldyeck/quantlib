...
Run: uv run --project . python -m quantlib.apex.experiments.m02_refit_frequency
...
from quantlib.apex.experiments.m01_window_length import GRID, prep, run_config, seg
...
def main() -> None:
    ...
    res.write_parquet("src/quantlib/apex/ledger/m02_refit_frequency.parquet")
    print(f"\ntotal {time.time()-t0:.0f}s;結果 → src/quantlib/apex/ledger/m02_refit_frequency.parquet")
