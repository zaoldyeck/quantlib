...
Run: uv run --project . python -m quantlib.apex.experiments.l01_build_packs
"""
...
from quantlib.apex.experiments.g01_ml_ranker import C, S_WTS, W3_START, prep
...
def main() -> None:
    ...
    with open("src/quantlib/apex/ledger/l01_packs.json", "w") as fh:
        json.dump(packs, fh, ensure_ascii=False, indent=1)
    pl.DataFrame(truth).write_parquet("src/quantlib/apex/ledger/l01_truth.parquet")
