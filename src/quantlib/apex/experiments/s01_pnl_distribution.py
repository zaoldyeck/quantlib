...
Run: uv run --project . python -m quantlib.apex.experiments.s01_pnl_distribution
依賴 cache: 是(需最新)
"""
...
from quantlib.apex.experiments.chart_s_vs_benchmarks import yearly_ret
from quantlib.apex.strategy_s import DS, prep, run_s  # 官方 S 引擎唯一真源
