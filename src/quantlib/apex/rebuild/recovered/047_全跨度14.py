...
來源:3d5413eb-b7db-45c8-bf62-efdef11c1375.jsonl @ 2026-07-09T10:17:16.867Z(工具 Bash)
...
print(f"v6 battery:bootstrap CI[{bs['ci_lo']:+.1%},{bs['ci_hi']:+.1%}] | DSR {dsr['dsr']:.4f}(N={n})"
      f" | PBO {pbo['pbo']:.3f} | perm p={p:.4f}(null 中位 {np.median(perm):+.1%} vs {s['cagr']:+.1%})")
