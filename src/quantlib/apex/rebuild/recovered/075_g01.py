# transcript 逐字復原(零改動)。
#
# 來源:3d5413eb-b7db-45c8-bf62-efdef11c1375.jsonl @ 2026-07-09T17:21:10.836Z(工具 Write:/Users/zaoldyeck/Documents/scala/quantlib/src/quantlib/apex/experiments/g01_ml_ranker.py)
...
Run: uv run --project . python -m quantlib.apex.experiments.g01_ml_ranker
"""
...
from quantlib.apex.assemble import FEATURE_COLS, build_features, entries_and_flags
...
def main() -> None:
    ...
    sc.write_parquet("src/quantlib/apex/ledger/g01_scores.parquet")
    ic_v = ic["ic"].to_numpy()
