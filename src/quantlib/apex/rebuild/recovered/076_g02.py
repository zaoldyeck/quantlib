# transcript 逐字復原(零改動)。
#
# 來源:3d5413eb-b7db-45c8-bf62-efdef11c1375.jsonl @ 2026-07-09T17:24:13.847Z(工具 Write:/Users/zaoldyeck/Documents/scala/quantlib/src/quantlib/apex/experiments/g02_lambdarank.py)
...
Run: uv run --project . python -m quantlib.apex.experiments.g02_lambdarank
"""
...
def main() -> None:
    ...
    for obj in ["lambdarank", "raw", "rankmse"]:
        ...
        sc.select(["date", C, "score"]).write_parquet(
            f"src/quantlib/apex/ledger/g02_scores_{obj}.parquet")
