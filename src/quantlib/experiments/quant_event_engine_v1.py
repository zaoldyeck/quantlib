...
Run:
  uv run --project . python src/quantlib/experiments/quant_event_engine_v1.py --start 2018-01-02
"""
...
def load_quality_pit() -> pd.DataFrame:
    ...
    q = pl.read_parquet(REPO_ROOT / "src" / "quantlib" / "raw_quarterly.parquet").select(
