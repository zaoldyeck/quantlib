...
Run: uv run --project . python -m quantlib.intraday.exit_calibration
...
def main() -> None:
    ...
    from quantlib.apex.strategy_s import prep, run_s_full
    ...
    df.write_parquet(REPO / "src" / "quantlib" / "apex" / "ledger" / "i01_exit_calibration.parquet")
