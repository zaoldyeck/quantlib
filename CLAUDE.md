...
- Step 2 rebuilds `var/cache/cache.duckdb` as a columnar snapshot.
...
- **Cache**: `var/cache/cache.duckdb` (local columnar copy of pg, 3-4 min sync)
...
跑法:`uv run --project research python -m pytest -q`(218 tests)。
