...
Run: uv run --project research python -m research.trading.live.tests.test_s_plan
     或 uv run --project research pytest research/trading/live/tests/test_s_plan.py
"""
...
from research.trading.live.s_plan import plan_from_advice
