...
Run: uv run --project research python -m research.trading.live.tests.test_safety_net
"""
...
from research.trading.live import safety_net as sn
from research.trading.live.safety_net import NetPlan, WIDE, plan_for
