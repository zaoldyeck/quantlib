...
但套用失敗」混為一談。當天實況是後者(VM 上 research/records/*.parquet 屬於別的
...
Run: uv run --project research python -m research.trading.live.tests.test_version
"""
from __future__ import annotations

from research.trading.live.version import Deployment, current
...
def test_email_subject_carries_drift_warning() -> None:
    ...
    import research.trading.live.notify as n
    orig = n._deployment
    try:
