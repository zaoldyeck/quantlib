...
Run: uv run --project research python -m research.crawl.refetch_quarter --year 2026 --quarter 1
"""
...
from research.crawl.sources import balance_sheet, cash_flows, income_statement
...
def refetch(year: int, quarter: int) -> None:
    ...
    from research.crawl.rebuild_financials import regen_raw_quarterly
    regen_raw_quarterly()
