...
Run: uv run --project research python -m research.serenity.wf.grand_duel
"""
...
def evergreen_nav() -> pd.Series:
    nav = pl.read_parquet(REPO_ROOT / "research/evergreen/data/ev36_top1_nav.parquet").to_pandas()
