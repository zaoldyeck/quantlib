...
# 觸發:`research.tri.daily` 每交易日第一次執行時 headless 自動觸發(吃訂閱額度)。
...
## 步驟
1. Read 現役冊 `/Users/zaoldyeck/Documents/scala/quantlib/research/serenity/registry/thesis_registry_2025.csv`
...
3. 逐條 append 到 `/Users/zaoldyeck/Documents/scala/quantlib/research/serenity/state/watch_log.jsonl`
   (一行一 JSON):{"date":"今日","signal","industry_or_codes","source","src_date",
   "kind":"candidate|theme_health","severity":"info|review|urgent","note"}
4. 寫 `/Users/zaoldyeck/Documents/scala/quantlib/research/serenity/state/curation_sweep_latest.json`:
