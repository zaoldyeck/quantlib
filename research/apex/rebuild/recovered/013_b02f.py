# transcript 逐字復原(零改動)。
#
# 來源:3d5413eb-b7db-45c8-bf62-efdef11c1375.jsonl @ 2026-07-09T00:49:20.994Z(工具 Write:/Users/zaoldyeck/Documents/scala/quantlib/research/apex/experiments/b09_blend_charter.py)
# 涵蓋 trials(1):b02f_core_trail35
"""B09 — blend 重審,門檻回歸憲章標準(預註冊見 ledger/batches.md)。

Run: uv run --project research python -m research.apex.experiments.b09_blend_charter
"""
