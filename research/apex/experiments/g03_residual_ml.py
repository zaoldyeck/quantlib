...
Run: uv run --project research python -m research.apex.experiments.g03_residual_ml
"""
...
def main() -> None:
    ...
    for name, axes, expanding in variants:
        ...
        sc.select(["date", C, "score"]).write_parquet(
            f"research/apex/ledger/g03_scores_{name}.parquet")
