...
Run: uv run --project research python -m research.apex.experiments.g04c_fundamentals
...
def main() -> None:
    ...
    q = (pl.read_parquet("research/apex/../raw_quarterly.parquet")
    ...
    sc = pl.concat(preds)
    sc.write_parquet("research/apex/ledger/g04c_scores_fwd10.parquet")
