...
Run: uv run --project research python -m research.apex.experiments.t02_turtle_magic
依賴 cache:是。
"""
...
from research.apex.experiments.m02_refit_frequency import BOOT_SEED, _metrics, _rets
