...
Run: uv run --project research python -m research.apex.experiments.q02_pure_financial_books
依賴 cache:是。
"""
...
def main() -> None:
    ...
    out.write_parquet("research/apex/ledger/q02_pure_financial.parquet")
