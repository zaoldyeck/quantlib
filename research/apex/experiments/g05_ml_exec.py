...
Run: uv run --project research python -m research.apex.experiments.g05_ml_exec
...
C = "company_code"
SC_PATH = "research/apex/ledger/g04_scores_fwd10.parquet"
OUT = "research/apex/ledger/g05_results.parquet"
