...
Run: uv run --project research python -m research.apex.experiments.x02_s_stability_combo
依賴 cache:是。
"""
...
from research.apex.strategy_s import prep as prep_s, run_s
from research.apex.experiments.q02_pure_financial_books import geo_rank, run_book
...
def main() -> None:
    ...
    pl.DataFrame([{**r} for r in rows]).write_parquet(
        "research/apex/ledger/x02_s_stability_combo.parquet")
