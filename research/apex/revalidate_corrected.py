...
Run: uv run --project research python -m research.apex.revalidate_corrected
依賴 cache: 是(需最新校正世代)。
"""
...
from research.apex.metrics import perf_stats, yearly_table
from research.apex.strategy_s import DS, prep, run_s
