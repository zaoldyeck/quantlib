...
Run: uv run --project research python -m research.intraday.bench_throughput
     uv run --project research python -m research.intraday.bench_throughput --workers 8 --n 16
"""
...
from research.intraday.pull_kbars import _login, _months, _remaining, _to_frame
from research.intraday.ratelimit import MARKET_CALLS, MARKET_WINDOW, RateLimiter
