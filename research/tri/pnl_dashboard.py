...
六線同窗(2022-07-11 起)至 cache 最新:S 最強(apex_revcycle_S 現役)、Evergreen
最強(live_config 現役)、Serenity 最強(ev_v3_wf 現役+最新縫合冊)、0050、00685L、
...
COLORS = {"Serenity 最強": "#2a78d6", "Evergreen 最強": "#008300", "S 最強": "#e87ba4",
...
<h1>三策略 PnL 永續追蹤 <span style='font-size:13px;color:#52514e'>(S / Evergreen / Serenity 現役最強 vs 0050 / 00685L / 2330)</span></h1>
...
def main() -> None:
    ...
    navs["Serenity 最強"] = serenity_nav(end)
    navs["Evergreen 最強"] = evergreen_nav(end)
    navs["S 最強"] = s_nav()
