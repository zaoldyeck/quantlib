...
OUT_DIR = BASE / "research" / "strat_lab" / "results" / "futures_tx_session"
...
def _write_doc(summary: pl.DataFrame, cutoff: str, elapsed: float) -> None:
    ...
    lines += [
        ...
        "## Artifacts",
        "",
        "- `research/strat_lab/results/futures_tx_session/session_strategy_summary.csv`",
        "- `research/strat_lab/results/futures_tx_session/top_daily.csv`",
        "- `research/strat_lab/results/futures_tx_session/top_trades.csv`",
    ]
    DOC_PATH.write_text("\n".join(lines) + "\n", encoding="utf-8")
