...
與 `research/trading/execution/` 嚴格分開,兩者過去同名(`execution`)造成持續誤 import:

| | 這裡 `research/execsim/` | `research/trading/execution/` |
|---|---|---|
...
零股最低手續費 1 元屬**帳戶層**規則,定義在 `research/trading/live/money.py`
