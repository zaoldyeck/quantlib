...
輸出 research/evergreen/data/ev18_packs/{surge,control}_NN.json。

需要 cache 最新。Run: uv run --project research python -m research.evergreen.ev18_make_packs
"""
...
OUT = "research/evergreen/data/ev18_packs"
