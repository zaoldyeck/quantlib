...
Run: uv run --project research python -m research.evergreen.ev25_compare
"""
...
def main() -> None:
    mid = (pl.read_parquet("research/evergreen/data/ev25_midmonth_labels.parquet")
           .with_columns(pl.col("code").str.extract(r"(\d{4})", 1)))
    beg = (pl.read_parquet("research/evergreen/data/ev17_chips_labels.parquet")
