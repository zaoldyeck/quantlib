...
Run: uv run --project research python -m research.evergreen.ev24_autopsy
"""
...
def main() -> None:
    ...
    trades = {}
    for name in ["v1", "v2"]:
        reg = pl.read_parquet(f"research/evergreen/data/registry_{name}.parquet")
    ...
    v2 = pl.read_parquet("research/evergreen/data/registry_v2.parquet")
    rows = []
