...
Run: uv run --project research python -m research.evergreen.ev24_validate <task_output_file>
"""
...
TABLE_DIR = "research/evergreen/data/ev17_tables"
PILOT = "research/evergreen/data/ev17_chips_labels.parquet"
OUT = "research/evergreen/data/registry_v2.parquet"
