...
Run: uv run --project research python -m research.evergreen.ev47_ml_axis
依賴 cache: 是 + research/apex/ledger/g04_scores_fwd10.parquet。
"""
...
OUT = "research/evergreen/data/ev47_results.parquet"
