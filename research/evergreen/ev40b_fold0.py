...
Run: uv run --project research python -m research.evergreen.ev40b_fold0
依賴 cache: 是
"""
...
from research.evergreen.ev36_walkforward import C
from research.evergreen.ev38_exhaust import (EXITS, FOLDS, GATES, LabX, bench,
                                             run)
from research.evergreen.ev40_validation import TOP1, geo_mean_cagr, oos_navs
